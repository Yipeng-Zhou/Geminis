...
{
    ros::init(argc, argv, "traj_publisher_2");
    ros::NodeHandle n;
    ros::Publisher desired_state_pub = n.advertise<trajectory_msgs::MultiDOFJointTrajectoryPoint>("/Quadrotor_2/desired_state", 1);
    ros::Subscriber nav_goal = n.subscribe("/Quadrotor_2/move_base/TrajectoryPlannerROS/local_plan", 1, nav_callback);
    ros::Subscriber cmd_vel = n.subscribe("/Quadrotor_2/cmd_vel", 1, cmd_vel_callback);
    ros::Subscriber state_trigger_sub = n.subscribe("/Quadrotor_2/state_trigger", 1, state_trigger_callback);
    ...
    while (ros::ok()) {
        ...
        std::stringstream ss;
        ss << "Trajectory Position Quadrotor 2"
